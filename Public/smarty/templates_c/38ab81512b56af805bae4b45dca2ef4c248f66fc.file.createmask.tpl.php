<?php /* Smarty version Smarty-3.1.21-dev, created on 2016-05-06 10:40:20
         compiled from "Public/smarty/templates/adminlte/createmask.tpl" */ ?>
<?php /*%%SmartyHeaderCode:186803383556d4a2700f4ee7-16511009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38ab81512b56af805bae4b45dca2ef4c248f66fc' => 
    array (
      0 => 'Public/smarty/templates/adminlte/createmask.tpl',
      1 => 1461938378,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '186803383556d4a2700f4ee7-16511009',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_56d4a270173e12_83673671',
  'variables' => 
  array (
    'url' => 0,
    'user' => 0,
...
<?php if ($_valid && !is_callable('content_56d4a270173e12_83673671')) {function content_56d4a270173e12_83673671($_smarty_tpl) {?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
...
/dist/img/ic_launcher.png" alt="" />
 ...
 $_from = $_smarty_tpl->tpl_vars['all_devices']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['device']->value['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['device']->value['username'];?>
</option>
                                <?php } ?>
                            </select>
                        </form>
...
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
/dist/js/tabledrop.js" type="text/javascript"><?php echo '</script'; ?>
>
    <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
